...
export const RankingsApi = {
  ...
  getTrackRankings: async (limit = 20, offset = 0): Promise<RankingTracksResponse> => {
    return apiRequest<RankingTracksResponse>(`/rankings/tracks?limit=${limit}&offset=${offset}`);
  },
};
